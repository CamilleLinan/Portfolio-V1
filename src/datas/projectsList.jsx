...
export const projectsList = [
    {
        ...
        imgEtap2: kasaEtap2,
        altEtap2: 'cover kasa openclassrooms etape 2',
        imgEtap3: kasaEtap3,
    ...
    },
    {
        ...
        altEtap2: 'cover groupomania openclassrooms etape 2',
        imgEtap3: groupoEtap3,
        altEtap3: 'cover groupomania openclassrooms etape 3',
        imgEtap4: groupoEtap4,
        altEtap4: 'cover groupomania openclassrooms etape 4',
        imgEtap5: groupoEtap5,
        altEtap5: 'cover groupomania openclassrooms etape 5',
        imgEtap6: groupoEtap6,
        altEtap6: 'cover groupomania openclassrooms etape 6',
        imgColors: groupoColors,
        altColors: 'groupomania openclassrooms colors',
    ...
    },
    {
        ...
        altEtap1: 'cover hot takes openclassrooms etape 1',
        imgEtap2: hottakesEtap2,
        altEtap2: 'cover hot takes openclassrooms etape 2',
    ...
    },
    {
        ...
        js: logoJS,
        imgEtap1: kanapEtap1,
        altEtap1: 'cover kanap openclassrooms etape 1',
        imgEtap2: kanapEtap2,
        altEtap2: 'cover kanap openclassrooms etape 2',
        imgEtap3: kanapEtap3,
        altEtap3: 'cover kanap openclassrooms etape 3',
        imgEtap4: kanapEtap4,
        altEtap4: 'cover kanap openclassrooms etape 4',
    ...
    },
    {
        ...
        altBefore: 'cover la panthere openclassrooms avant',
        imgAfter: lapanthereAfter,
        altAfter: 'cover la panthere openclassrooms après',
    ...
    },
    {
        ...
        altDesk: 'cover ohmyfood openclassrooms desktop',
        imgTab: ohmyfoodTab,
        altTab: 'cover ohmyfood openclassrooms tablette',
        imgMobile: ohmyfoodMobile,
        altMobile: 'cover ohmyfood openclassrooms mobile',
        imgColors: ohmyfoodColors,
        altColors: 'ohmyfood openclassrooms colors',
        imgIcons: ohmyfoodIcons,
        altIcons: 'ohmyfood openclassrooms icons',
    ...
    },
    {
        ...
        css: logoCss,
        imgDesk: bookiDesk,
        altDesk: 'cover booki openclassrooms desktop',
        imgTab: bookiTab,
        altTab: 'cover booki openclassrooms tablette',
        imgMobile: bookiMobile,
        altMobile: 'cover booki openclassrooms mobile',
        imgColors: bookiColors,
        altColors: 'booki openclassrooms colors',
        imgIcons: bookiIcons,
        altIcons: 'booki openclassrooms icons',
