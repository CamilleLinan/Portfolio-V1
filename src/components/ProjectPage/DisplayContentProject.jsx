                        ...
                        {project.imgEtap1 && project.imgEtap2 && <>
                            ...
                            <article className='project_page_cover_imgs'>
                                ...
                                {project.imgEtap3 && project.imgEtap4 && <>
                                    ...
                                    <img src={project.imgEtap4} alt={project.altEtap4} className='project_page_cover_img_etap' />
                                </>}
                                {project.imgEtap5 && project.imgEtap6 && <>
                                    <img src={project.imgEtap5} alt={project.altEtap5} className='project_page_cover_img_etap' />
                                    <img src={project.imgEtap6} alt={project.altEtap6} className='project_page_cover_img_etap' />
                                </>}
                            </article>
